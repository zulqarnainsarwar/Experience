...
import impostor from "../impostor.jpeg";
      ...
      <div className="pt-20 w-11/12 flex-col flex lg:flex-row justify-center items-center overflow-x-auto">
        <div className="w-full lg:w-2/5 lg:pl-10">
          ...
          <Heading
            text={"Enigmara"}
            paragraph={
              "Find the IMPOSTOR! In this map at the bottom of the ocean, you have to complete quests and face events to survive! Don't hesitate to follow me on TWITTER : @Keeneo9 to follow updates of the map!"
            }
          />
        ...
        <div className="w-full lg:w-3/5 relative">
          ...
          <div className="bg-hero_two bg-cover bg-center min-h-[600px] min-w-[1050px] relative">
            {/*  Video component */}
            <Link
              className="block z-20 w-[11px] h-[11px] cursor-pointer"
              onClick={() => setModelShow(true)}
              // target="_"
              style={{ position: "absolute", left: "54.8044%", top: "53%" }}
